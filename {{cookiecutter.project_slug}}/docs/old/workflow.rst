...
Workflow
========
This is an evolving document detailing the workflow to setup and run the {{cookiecutter.project_slug}} configuration. 
...
the {{cookiecutter.project_slug}} domain as a sub region of eORCA12. This enables us to avoid having to recompute the SBC 
